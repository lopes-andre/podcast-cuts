...
app.include_router(highlight_comments.router, prefix="/api/highlights", tags=["highlight_comments"])
app.include_router(highlight_segments.router, prefix="/api/highlights", tags=["highlight_segments"])
